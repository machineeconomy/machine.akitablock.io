...
.footer__background {
  ...
  width: 50%;
  height: 155%;
  background: url("./assets/MachineChain.png") no-repeat;
...
.linkedIn {
  background: url("./assets/linkedin_logo.png");
}
.twitter {
  background: url("./assets/twitter_logo.png");
}
.gitHub {
  background: url("./assets/github_logo.png");
}
.iota {
  background: url("./assets/Iota_logo.png");
}
.network__link {
  display: block;
  height: 60px;
